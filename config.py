...
class Config_G1:
    def __init__(self):
        ...
        self.MAX_BATCH_POINTS_G1 = 5000      # Max number of batch samples to save
        ...
        self.LEARNING_RATE_G1 = 0.00009       # Base learning rate for Adam optimizer Best value: 0.000493
